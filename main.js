...
function onBot() {
  ...
  // MrTomXxX :) hide your credentials in env, available in render "Environment" and replit secrets
      ...
      (async () => {
        ...
        for (const command of listCommand) {
          try {
            ...
            global.loading.err(
              `${chalk.hex("#ff7100")(`LOADED`)} ${chalk.hex("#FFFF00")(
                command
              )} fail ` + error,
              "COMMAND"
            );
      ...
      (async () => {
        ...
        for (const ev of events) {
          try {
            ...
            global.loading.err(
              `${chalk.hex("#ff0000")("ERROR!")} ${cb(ev)} failed with error: ${
                err.message
              }` + `\n`,
              "EVENT"
            );
